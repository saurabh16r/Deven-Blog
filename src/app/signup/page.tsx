...
function SignupFormContent() {
  ...
  return (
    <div className="w-full max-w-[440px] px-6 py-10 sm:py-14 bg-background border border-border rounded-lg shadow-sm">
      {/* Editorial Header */}
      ...
      <form onSubmit={handleSubmit} className="space-y-4.5">
        <div>
          <label className="block text-xs font-bold uppercase tracking-wider text-muted mb-1.5" htmlFor="name">
            Full Name
          </label>
          <input
            id="name"
        ...
        <div>
          <label className="block text-xs font-bold uppercase tracking-wider text-muted mb-1.5" htmlFor="confirmPassword">
            Confirm Password
          </label>
          <input
            id="confirmPassword"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2.5 px-4 bg-primary text-primary-foreground hover:bg-primary-hover font-bold text-sm tracking-wide rounded-lg transition-colors cursor-pointer flex items-center justify-center mt-2"
        >
